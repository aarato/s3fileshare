...
- Login uses IAM Access Key + Secret Key dynamically generated by Terraform, scoped exclusively to this app's S3 bucket — no credentials are stored in config files and the keys are destroyed with the environment.
